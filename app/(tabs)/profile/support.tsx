...
export default function SupportScreen() {
  ...
  const WHATSAPP_MESSAGE = encodeURIComponent("Hello Amsy Support, I need help with my account.");

  const supportItems = [
    {
      icon: "envelope",
      title: "Email Support",
      description: "support@amsy.ng",
      action: () => Linking.openURL("mailto:amsykano99@gmail.com"),
    },
    {
      icon: "phone",
      title: "Call Us",
    ...
    },
    {
      ...
      action: () => Linking.openURL("https://help.amsydatasub.com"),
    },
  ];
  ...
  return (
    <>
      ...
      <Box className="flex-row items-start px-4 py-3 mx-4 mb-8 rounded-lg bg-info-50 border border-info-200 gap-3">
        <FontAwesome name="info-circle" size={16} color="#2dd4bf" />

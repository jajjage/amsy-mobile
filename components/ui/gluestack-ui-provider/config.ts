...
export const config = {
  light: vars({
    ...
    '--color-error-500': '239 68 68', // #E53935
    ...
    '--color-typography-600': '100 116 139', // #52575F - mutedForeground
    '--color-typography-700': '64 64 64',
    '--color-typography-800': '18 18 18', // #121212 - foreground
    ...
    '--color-background-muted': '241 245 249', // #E8E9EA
    '--color-background-info': '239 246 255',

    /* Focus Ring Indicator */
    '--color-indicator-primary': '45 212 191', // #2dd4bf
  ...
  dark: vars({
    ...
    '--color-indicator-primary': '45 212 191', // #D4A017

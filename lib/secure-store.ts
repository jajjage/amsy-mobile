...
const ACCESS_TOKEN_KEY = "amsy_access_token";
const REFRESH_TOKEN_KEY = "amsy_refresh_token";
const USER_CACHE_KEY = "amsy_user_cache";
const USER_ROLE_KEY = "amsy_user_role";

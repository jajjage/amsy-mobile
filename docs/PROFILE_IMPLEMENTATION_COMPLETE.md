...
## Overview
Complete implementation of the Profile feature for Amsy Mobile (iOS/Android/Web), including personal info management, security hub, biometric device management, notification preferences, payment methods, and support.
...
### Color Palette
- **Primary**: `lightColors.primary` (Amsy gold #E69E19)

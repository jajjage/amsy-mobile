...
- PROD: RP ID hash = SHA256("amsydatasub.com")
...
attestationObject = base64url(CBOR.encode({
  ...
  attStmt: {},
  authData: <binary>
    [61, 61, 61, ..., XX]         // Real SHA256("amsydatasub.com")
    [0x45]                        // Flags: UP + UV
...
| Prod | SHA256("amsydatasub.com") | Real | 32 bytes |
...
// Production
rpIdHash = sha256("amsydatasub.com")
         = [0x3d, 0x8c, 0xa8, ..., 0x9f]
```
...
# RP ID hash = SHA256("amsydatasub.com")
...
const hash = sha256("amsydatasub.com");
